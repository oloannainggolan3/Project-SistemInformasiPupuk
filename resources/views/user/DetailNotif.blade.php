...
<head>
    ...
    <title>Detail Notifikasi - Pupuk & Bibit Subsidi</title>
            ...
            <div class="notif-panel">
                <div class="notif-inner">
                    <div class="notif-head">
                        ...
                        <div class="notif-title">Verifikasi Akun Pengguna Berhasil</div>
                        <div class="notif-date">02/09/2025</div>
                    </div>

                    <div class="notif-body">
                        <p>"Selamat datang secara resmi di Website Pupuk & Bibit Subsidi! 🎉</p>

                        <p>Kami senang sekali mengumumkan bahwa proses verifikasi akun Anda telah berhasil diselesaikan dengan sempurna.</p>

                        <p>Terima kasih banyak atas kesabaran dan kerjasama Anda selama langkah ini. Sekarang, akun Anda sudah siap untuk dijelajahi sepenuhnya! Anda bisa mulai:</p>

                        <ul>
                            <li>Mulai berbelanja produk Pupuk & Bibit Subsidi Pemerintah.</li>
                            <li>Berinteraksi dengan ribuan pengguna lain yang juga telah terverifikasi.</li>
                            <li>Menikmati pengalaman bebas bereksplorasi dan konsultasi terkait Pupuk dan Bibit Subsidi Pemerintah.</li>
                        </ul>
                        ...
                        <p>Terima kasih lagi, dan selamat berpetualang! 🚜🌾</p>
                    </div>
                </div>
            </div>
        </div>
